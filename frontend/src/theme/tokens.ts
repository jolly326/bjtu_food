...
/* ================= 品牌主色（Primitive） ================= */
/**
 * 产品决策：全站主题色统一为「砖红色系」（不再深浅分红/橙）。
 *  - 浅色模式主色 = 深砖红（用户指定 #7A241A），白字按钮 AA 达标（≈10:1）
 *  - 深色模式主色 = 同色相提亮砖红 #C05A48（直接使用 #7A241A 在深底上对比不足 ~1.9:1，
 *    按钮/选中态不可见；#C05A48 仍属砖红而非橙，深底可见、白字 AA 达标）
 */
export const COLOR_PRIMARY_LIGHT = '#7A241A'
/** 浅色主色暗阶（hover / 深按） */
export const COLOR_PRIMARY_DARK_LIGHT = '#5E1A10'
/** 深色模式主色（砖红色相提亮，深底醒目；白字 AA 达标） */
export const COLOR_PRIMARY_DARK = '#C05A48'
/** 深色主色暗阶 */
export const COLOR_PRIMARY_DARK_DARK = '#9C4532'
/** 主色上的文字：深浅均为白/暖白（深砖红底配白字） */
 ...
 * 产品决策：header / home-top 等大面积品牌色块**深浅模式统一用深砖红**
 * （暗陶土红），保证品牌识别一致，避免浅色下亮红块、深色下亮橙块的不一致观感。
 */
export const COLOR_PRIMARY_SURFACE_LIGHT = '#7A241A'
export const COLOR_PRIMARY_SURFACE_DARK = '#7A241A'
/** 表面上的文字/图标：深砖红表面配白/暖白字（AA 达标） */
...
/** 价格红：与主色同 hue 但更深更饱和（浅色），深色提亮暖橙红（与 error 区分） */
export const COLOR_PRICE_LIGHT = '#B0351F'
export const COLOR_PRICE_DARK = '#FF8B72'

/** 错误 / 成功 / 警示 / 喜欢（浅色基准 + 深色提亮） */
export const COLOR_ERROR_LIGHT = '#E54D42'
export const COLOR_ERROR_DARK = '#E5655A'
...
/** 边框两档（细边框 / 强调边框） */
export const COLOR_BORDER_LIGHT = '#ECE6E0'
export const COLOR_BORDER_DARK = '#2E2A27'
export const COLOR_BORDER_BOLD_LIGHT = '#C9BFB6'
