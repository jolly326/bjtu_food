...
- **我的评价（2026-09-12）**：新增「我的评价」格（`requireAuth`）与「我的评价」列表页（现路径 `pages/my-reviews`，2026-09-15 个人中心域分包拆分前为 `pages/me/my-reviews`；本人删除 + 空态双口径），复用 `DELETE /reviews/{id}`；2026-09-13 随活动下线宫格由 2×2 收敛回一行 3 列（意见反馈 / 系统通知 / 我的评价）。
