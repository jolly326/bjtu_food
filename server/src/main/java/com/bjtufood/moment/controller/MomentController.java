...
public class MomentController {
    ...
    @Operation(summary = "评论「有用」切换（幂等）", description = "STU（需邮箱认证）。一人一票，未标记→true+1，已标记→false-1（moment-comment-thread-view 恢复）。", security = @SecurityRequirement(name = "bearerAuth"))
    @RequireVerified
