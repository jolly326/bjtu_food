 ...
 *
 * 依赖：由页面在 <script setup> 中同步调用，内部注册 onLoad/onShow/onUnload/onPageScroll/onReachBottom/onShareAppMessage/onMounted。
 */
...
onShareAppMessage(() => ({
  ...
  path: `/pages/detail/dish/index?id=${dishId.value}`,
}))
