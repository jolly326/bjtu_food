...
> 已完成任务的 task-*.md 文档已随落地收尾删除（仅保留本索引一行状态）。当前**仍存活**的 task 文档为 task-05、task-06（均未完全完成）。
...
- 已完成 task 的归档文档（task-01/02/03/04/07/08/09/10/11 的 .md，2026-08-02 随收尾删除，状态见上表）
